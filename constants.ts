...
export const SPELLS_DB: Record<string, { 
  ...
  "Amizade": { level: "Truque", school: "Encantamento", desc: "Você tem vantagem em testes de Carisma contra uma criatura não hostil. Quando a magia acaba, ela percebe o uso e fica hostil.", castingTime: "1 Ação", range: "Pessoal", components: "S, M", duration: "Concentração, até 1 min", concentration: true },
  "Bênção": { level: "1º Nível", school: "Encantamento", desc: "Abençoa 3 criaturas com +1d4 em ataques e salvaguardas.", castingTime: "1 Ação", range: "9m", components: "V, S, M", duration: "Concentração, até 1 min", concentration: true },
  "Fogo das Fadas": { level: "1º Nível", school: "Evocação", desc: "Contorna alvos com luz, concedendo vantagem em ataques contra eles.", castingTime: "1 Ação", range: "18m", components: "V", duration: "Concentração, até 1 min", concentration: true },
  "Enfeitiçar Pessoa": { level: "1º Nível", school: "Encantamento", desc: "Encanta um humanoide para torná-lo amigável a você.", castingTime: "1 Ação", range: "9m", components: "V, S", duration: "1 hora", concentration: false },
  "Riso Histérico de Tasha": { level: "1º Nível", school: "Encantamento", desc: "Faz um alvo rir incontrolavelmente, ficando caído e incapacitado.", castingTime: "1 Ação", range: "9m", components: "V, S, M", duration: "Concentração, até 1 min", concentration: true },
  "Identificar": { level: "1º Nível", school: "Adivinhação", desc: "Revela propriedades mágicas de um item ou criatura.", castingTime: "1 minuto (Ritual)", range: "Toque", components: "V, S, M", duration: "Instantânea", concentration: false },
  "Disfarçar-se": { level: "1º Nível", school: "Ilusão", desc: "Altera sua aparência física e de suas vestimentas.", castingTime: "1 Ação", range: "Pessoal", components: "V, S", duration: "1 hora", concentration: false },
  "Imagem Silenciosa": { level: "1º Nível", school: "Ilusão", desc: "Cria uma imagem visual de um objeto ou criatura de até 4,5m.", castingTime: "1 Ação", range: "18m", components: "V, S, M", duration: "Concentração, até 10 min", concentration: true },
  "Orientação": { level: "Truque", school: "Adivinhação", desc: "O alvo recebe +1d4 em um teste de habilidade à escolha dele.", castingTime: "1 Ação", range: "Toque", components: "V, S", duration: "Concentração, até 1 min", concentration: true },
  "Druidismo": { level: "Truque", school: "Transmutação", desc: "Cria efeitos naturais menores (previsão do tempo, flores abrir, som de bicho).", castingTime: "1 Ação", range: "9m", components: "V, S", duration: "Instantânea", concentration: false },
  "Escrita Ilusória": { level: "1º Nível", school: "Ilusão", desc: "Faz uma mensagem parecer outra para quem você não designar.", castingTime: "1 minuto", range: "Toque", components: "S, M", duration: "10 dias", concentration: false },
  "Dardo de Fogo": { 
    level: "Truque", 
    school: "Evocação", 
  ...
  "Passo Nebuloso": { level: "2º Nível", school: "Conjuração", desc: "Brevemente cercado por fumaça prateada, você se teletransporta até 9 metros para um espaço desocupado que você possa ver.", castingTime: "1 Ação Bônus", range: "9m", components: "V", duration: "Instantânea", concentration: false },
  "Nuvem de Adagas": { level: "2º Nível", school: "Conjuração", desc: "Você preenche o ar com adagas giratórias em um cubo de 1,5 metro. No seu turno e quando uma criatura entra ou para lá, ela sofre 4d4 de dano cortante.", castingTime: "1 Ação", range: "18m", components: "V, S, M", duration: "Concentração, até 1 min", concentration: true },
  "Passar Muralhas": { level: "5º Nível", school: "Transmutação", desc: "Você cria uma passagem através de uma superfície de madeira, gesso ou pedra.", castingTime: "1 Ação", range: "Toque", components: "V, S, M", duration: "1 hora", concentration: false },
  "Visão Verdadeira": { level: "6º Nível", school: "Adivinhação", desc: "Você toca uma criatura e dá a ela a habilidade de ver as coisas como elas realmente são por 1 hora.", castingTime: "1 Ação", range: "Toque", components: "V, S, M", duration: "1 hora", concentration: false },
  "Inverter a Gravidade": { level: "7º Nível", school: "Transmutação", desc: "A gravidade é invertida em um cilindro de 15 metros de raio por 30 metros de altura.", castingTime: "1 Ação", range: "30m", components: "V, S, M", duration: "Concentração, até 1 min", concentration: true },
...
export const DEFAULT_MONSTERS: Monster[] = [
    ...
    { 
      id: 710, name: "Vampiro Recruta (Clã da Noite)", type: "Morto-vivo", cr: "4", ac: 14, hp: 65, speed: "9m", 
      actions: [{n: "Mordida Faminta", hit: 5, dmg: "1d6+3 perfurante"}, {n: "Garras Rápidas", hit: 5, dmg: "1d8+3 cortante"}], 
      traits: [{n: "Regeneração Sombria", d: "Recupera 5 PV no início de seu turno se não estiver no sol."}],
      attributes: { str: 14, dex: 16, con: 14, int: 10, wis: 12, cha: 14 },
      essence: { 
        id: "ess_vamp_rec", name: "Essência da Sede Recruta", monsterSource: "Vampiro Recruta", cr: "4", 
        attributeBonus: { attr: 'dex', value: 1 }, 
        passive: { name: "Agilidade Noturna", desc: "Você ganha +1,5m de deslocamento." },
        active: { name: "Drenagem Leve", desc: "Ao causar dano, cure 1d4 PV.", limit: "1/descanso" }
      },
      drops: [{ n: "Capa de Veludo Velha", d: "Uma capa elegante, porém gasta.", r: "Comum" }]
    },
    { 
      id: 711, name: "Vampiro Cavaleiro Sanguinário", type: "Morto-vivo", cr: "5", ac: 16, hp: 85, speed: "9m", 
      actions: [{n: "Espada de Sangue", hit: 7, dmg: "2d6+4 cortante + 1d6 necrótico"}, {n: "Mordida Voraz", hit: 7, dmg: "1d8+4 perfurante + 2d6 necrótico (Cura)"}], 
      traits: [{n: "Resistência Sobrenatural", d: "Resistência a dano não-mágico."}],
      attributes: { str: 18, dex: 14, con: 16, int: 12, wis: 12, cha: 16 },
      essence: { 
        id: "ess_vamp_cav", name: "Essência do Cavaleiro Rubro", monsterSource: "Vampiro Cavaleiro", cr: "5", 
        attributeBonus: { attr: 'str', value: 1 }, 
        passive: { name: "Armadura de Sangue", desc: "Você ganha +1 na CA." },
        active: { name: "Golpe Sanguinário", desc: "Seu próximo ataque causa +2d6 dano necrótico.", limit: "1/descanso" }
      },
      drops: [{ n: "Anel de Sinete da Noite", d: "Um anel que brilha levemente no escuro.", r: "Incomum" }]
    },
    { 
      id: 712, name: "Vampiro Alto Sacerdote", type: "Morto-vivo", cr: "6", ac: 15, hp: 100, speed: "9m", 
      actions: [{n: "Toque Vampírico", hit: 7, dmg: "3d6 necrótico (Cura)"}, {n: "Rajada Sombria", hit: 7, dmg: "4d6 necrótico"}], 
      traits: [{n: "Conjurador nato", d: "Conhece magias de necromancia."}],
      attributes: { str: 12, dex: 16, con: 14, int: 18, wis: 16, cha: 18 },
      essence: { 
        id: "ess_vamp_sac", name: "Essência do Olhar Eterno", monsterSource: "Vampiro Sacerdote", cr: "6", 
        attributeBonus: { attr: 'wis', value: 2 }, 
        passive: { name: "Intuição Sombria", desc: "Vantagem em testes de Percepção." },
        active: { name: "Névoa de Medo", desc: "Libera uma aura que amedronta inimigos.", limit: "1/descanso longo" }
      },
      drops: [{ n: "Cajado de Ébano", d: "Atua como foco arcano +1.", r: "Raro" }]
    },
    { 
      id: 713, name: "Vampiro Comandante Legião", type: "Morto-vivo", cr: "7", ac: 17, hp: 120, speed: "9m", 
      actions: [{n: "Lança Cruel", hit: 8, dmg: "2d10+5 perfurante"}, {n: "Brado da Noite", hit: 0, dmg: "Aliados ganham vantagem"}], 
      traits: [{n: "Liderança Tática", d: "Aliados a até 9m ganham +2 no ataque."}],
      attributes: { str: 20, dex: 16, con: 18, int: 14, wis: 14, cha: 20 },
      essence: { 
        id: "ess_vamp_com", name: "Essência do General da Noite", monsterSource: "Vampiro Comandante", cr: "7", 
        attributeBonus: { attr: 'cha', value: 2 }, 
        passive: { name: "Comando Superior", desc: "Aliados a até 3m ganham +1 em Saves." },
        active: { name: "Fúria do Comandante", desc: "Garante um ataque extra para si ou aliado.", limit: "1/descanso longo" }
      },
      drops: [{ n: "Medalhão de Comando", d: "Dá vantagem em testes de Intimidação.", r: "Raro" }]
    },
...
export const CLASS_SPELLS: Record<string, string[]> = {
  ...
  'Druida': ["Chicote de Espinhos", "Criar Fogueira", "Orientação", "Resistência", "Druidismo", "Amizade Animal", "Bom Fruto", "Enfeitiçar Pessoa", "Comunhão com a Natureza", "Criar ou Destruir Água", "Curar Ferimentos", "Detectar Magia", "Detectar Venenos e Doenças", "Emaranhar", "Falar com Animais", "Fogo das Fadas", "Névoa Obscurecente", "Onda Trovejante", "Palavra Curativa", "Purificar Alimentos e Bebidas", "Salto", "Aprimorar Habilidade", "Chama Contínua", "Crescer Espinhos", "Esfera Flamejante", "Imobilizar Pessoa", "Localizar Animais ou Plantas", "Localizar Objeto", "Mensageiro Animal", "Passos Sem Pegadas", "Pele de Árvore", "Proteção contra Veneno", "Restauração Menor", "Sentido Bestial", "Visão no Escuro", "Caminhar na Água", "Conjurar Animais", "Dissipar Magia", "Falar com Plantas", "Luz do Dia", "Mesclar-se às Rochas", "Muralha de Vento", "Nevasca", "Proteção contra Energia", "Respirar na Água"],
  'Feiticeiro': ["Amizade", "Chicote de Espinhos", "Criar Fogueira", "Dardo de Fogo", "Ilusão Menor", "Luz", "Mãos Mágicas", "Mensagem", "Prestidigitação", "Raio de Gelo", "Toque Chocante", "Armadura Arcana", "Enfeitiçar Pessoa", "Compreender Idiomas", "Detectar Magia", "Disfarçar-se", "Escudo Arcano", "Mãos Flamejantes", "Mísseis Mágicos", "Névoa Obscurecente", "Onda Trovejante", "Orbe Cromático", "Queda Suave", "Raio Bruxo", "Recuo Acelerado", "Salto", "Vida Falsa", "Alterar-se", "Aprimorar Habilidade", "Aumentar/Reduzir", "Cegueira/Surdez", "Coroa da Loucura", "Despedaçar", "Detectar Pensamentos", "Escuridão", "Esfera Flamejante", "Invisibilidade", "Levitar", "Nublar", "Patas de Aranha", "Prender à Terra", "Sopro do Dragão", "Sugestão", "Ver o Invisível", "Visão no Escuro"],
  'Bruxo': ["Amizade", "Explosão Mística", "Ilusão Menor", "Mãos Mágicas", "Prestidigitação", "Toque Chocante", "Armadura de Agathys", "Braços de Hadar", "Enfeitiçar Pessoa", "Compreender Idiomas", "Bruxaria (Hex)", "Mãos Flamejantes", "Proteção contra o Bem e o Mal", "Raio Bruxo", "Recuo Acelerado", "Servo Invisível", "Cativar", "Coroa da Loucura", "Escuridão", "Imobilizar Pessoa", "Invisibilidade", "Nuvem de Adagas", "Passo Nebuloso", "Patas de Aranha", "Raio do Enfraquecimento", "Sugestão"],
  'Paladino': ["Auxílio", "Bênção", "Comando", "Curar Ferimentos", "Detectar Bem e Mal", "Detectar Magia", "Detectar Venenos e Doenças", "Duelo Compelido", "Escudo da Fé", "Favor Divino", "Heroísmo", "Proteção contra o Bem e o Mal", "Purificar Alimentos e Bebidas", "Santuário", "Arma Mágica", "Localizar Objeto", "Oração Curativa", "Proteção contra Veneno", "Restauração Menor", "Vínculo Protetor", "Zona da Verdade", "Aura de Vitalidade", "Luz do Dia", "Manto do Cruzado", "Proteção contra Energia", "Remover Maldição", "Revivificar"],
  'Patrulheiro': ["Alarme", "Amizade Animal", "Bom Fruto", "Curar Ferimentos", "Detectar Magia", "Detectar Venenos e Doenças", "Falar com Animais", "Marca do Caçador", "Névoa Obscurecente", "Passos Sem Pegadas", "Salto", "Saraivada de Espinhos", "Ziguezague", "Mensageiro Animal", "Passos Sem Pegadas", "Pele de Árvore", "Proteção contra Veneno", "Restauração Menor", "Silêncio", "Visão no Escuro", "Caminhar na Água", "Conjurar Animais", "Luz do Dia", "Proteção contra Energia", "Respirar na Água"],
...
export const RACE_FEATURES: Record<string, Record<number, string[]>> = {
  ...
  'Tiefling Feral': { 1: ['Repreensão Infernal'], 3: ['Repreensão Infernal'], 5: ['Escuridão'] },
